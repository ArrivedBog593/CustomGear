...
> Esta página está incompleta. Por ahora cubre 2.0.0, 1.7.0, 1.6.0, y el cambio de
...
port a Minecraft 26.1.2. Copia tu carpeta de contenido y carga.

Lo que sí cambia es el jar, y nada de esto es opcional:

- **La 2.0.0 corre solo en Minecraft 26.1.2.** La 1.7.0 no carga ahí, y esta no
...
- **GeckoLib 5.5.2**, **JEI 29.29.0.77**, **Curios 15.0.0**. Las versiones que
  usabas junto a la 1.7.0 no cargan en 26.1.2
